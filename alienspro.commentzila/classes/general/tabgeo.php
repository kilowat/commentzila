<?php
//(c) Pavel Trunin pavel.trunin@gmail.com
...
class TabGeo
{
	 ...
	 *
	 */
	protected $iso = array('AD', 'AE', 'AF', 'AG', 'AI', 'AL', 'AM', 'AO', 'AQ', 'AR', 'AS', 'AT', 'AU', 'AW', 'AX', 'AZ',
	...
	{
		$this->fh = fopen(__DIR__.'/tabgeo_country_v4.dat', 'rb');
	}
	 ...
	 * @return array|int
	 */
	protected function tabgeo_bs($data_array, $ip, $step)
	{
		$start = 0;
